        ...
        <>
            ...
            >
                ...
                >
                        ...
                        onClick={(e) => {
                            if (
                                ...
                                const updatedTimelineProps = (
                                    ...
                                    return JSON.parse(localStorage.getItem('checkedForDelete')).indexOf(index) === -1;
                                });
                                localStorage.removeItem('timelineProps');
                                localStorage.setItem('timelineProps', JSON.stringify(updatedTimelineProps));
                    ...
                    <Button
                        ...
                        onClick={(e) => {
                            ...
                            let updatedModifiedSubtitleContent = modifiedSubtitleContent.map((item, index) => ({
                                ...item,
                                id: index + 1,
                            }));
                            ...
                            const modifiedSubtitleBlob = new Blob([JSON.stringify(updatedModifiedSubtitleContent)], {
                                type: 'text/srt',
                            });
                            const downloadLink = URL.createObjectURL(modifiedSubtitleBlob);
                            const a = document.createElement('a');
                ...
                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <div style={{ color: '#FFF' }} id="endTime">
                                                                {new Date(node.end * 1000).toISOString().slice(12, 23)}
                                                            </div>
                                                        </div>
                                                    </Stack>
                    ...
                    <Grid xs={6} lg={4}>
                        <Box id="right-panel" sx={{ fontSize: '12px', textTransform: 'uppercase' }}>
                            <video
                                id="v-5417"
